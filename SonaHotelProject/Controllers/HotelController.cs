    ...
    public class HotelController : Controller
    {
        public async Task<IActionResult> Index(string cityId, string checkInDate, string checkOutDate)
        {
            ...
            var request = new HttpRequestMessage
            {
                ...
                RequestUri = new Uri($"https://booking-com.p.rapidapi.com/v2/hotels/search?dest_id={cityId}&order_by=popularity&checkout_date={formattedCheckOutDate}&children_number=2&filter_by_currency=AED&locale=en-gb&dest_type=city&checkin_date={formattedCheckInDate}&categories_filter_ids=class%3A%3A2%2Cclass%3A%3A4%2Cfree_cancellation%3A%3A1&children_ages=5%2C0&include_adjacency=true&page_number=0&adults_number=2&room_number=1&units=metric"),
                Headers =
                        {
